 ...
 * Purpose:  1st version of project 2
 *           adding a void function 
 *           to display the slots and 
     *       utilize an array
 *  
 */
...
//Function Prototype
void slots (int &,int &,int &,int &,int & ,int &,int &,int & ,int &);
int Times (int[]);
bool winT(int);
